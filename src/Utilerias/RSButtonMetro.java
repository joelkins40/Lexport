...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
    ...
    private Color colorNormal = new Color(239, 238, 244);
    ...
    private Color colorTextNormal = new Color(128,128,131);
    private Color colorTextPressed = new Color(128,128,131);
    private Color colorTextHover = new Color(128,128,131);
